            ...
            items: [
              {
                ...
                description: `${drawingName} を利用している親プロジェクトです。工程改善向けの確認タスクを紐付けています。`,
                chips: ["進行中", "製造改善"],
              },
            ],
          },
            ...
            items: [
              {
                ...
                description: `${drawingName} が属する製品・装置・ユニット系統です。部品表や派生図面への接続を想定しています。`,
                chips: ["量産", "標準"],
              },
            ],
          },
            ...
            items: [
              {
                ...
                title: drawingName,
                subtitle: drawingNumber,
                description: "図面と同一識別子で参照される部品情報です。将来的に ERP / BOM の参照先へ差し替えできます。",
                chips: tags,
              },
            ],
          },
            ...
            items: [
              {
                ...
                title: "レビューコメント",
                subtitle: "2026/04/13",
                description: "修正箇所の確認依頼と、関連部門からの回答を表示しています。",
                chips: ["確認依頼", "回答待ち"],
              },
            ],
          },
