        ...
        previews.append(
            {
                ...
                "llmField": _display_value(candidate.get("llm_field")),
                "llmConfidence": _display_value(candidate.get("llm_confidence")),
                "llmReason": _display_value(candidate.get("llm_reason")),
...
def build_2d_snapshot_display(*, raw_extract: dict | None, canonical_attributes: dict | None) -> dict:
    ...
    summary_rows = [
        ...
        _make_row("curve_section_candidate_count", "曲線/ハッチング候補数", canonical_attributes.get("curve_section_candidate_count")),
    ...
    geometry_attribute_rows = [
        ...
        _make_display_row(
            ...
            "曲線/ハッチング候補",
            canonical_attributes.get("curve_section_candidates", []),
            str(len(canonical_attributes.get("curve_section_candidates", []) or [])),
        ),
    ]
