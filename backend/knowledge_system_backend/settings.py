"""Django backendの環境変数・DB・アプリ・ログなどの実行設定を定義する。
...
DRAWING_METADATA_EXTRACTOR_TIMEOUT_SECONDS = int(os.getenv("DRAWING_METADATA_EXTRACTOR_TIMEOUT_SECONDS", "180"))
DRAWING_METADATA_WORKER_POLL_SECONDS = int(os.getenv("DRAWING_METADATA_WORKER_POLL_SECONDS", "5"))
DRAWING_METADATA_WORKER_BATCH_SIZE = int(os.getenv("DRAWING_METADATA_WORKER_BATCH_SIZE", "8"))
DRAWING_METADATA_JOB_LEASE_SECONDS = int(os.getenv("DRAWING_METADATA_JOB_LEASE_SECONDS", "180"))
DRAWING_METADATA_WORKER_HEARTBEAT_STALE_SECONDS = int(
    os.getenv("DRAWING_METADATA_WORKER_HEARTBEAT_STALE_SECONDS", "30")
)
DRAWING_METADATA_AGENT_TOKEN = os.getenv("DRAWING_METADATA_AGENT_TOKEN", "").strip()
DRAWING_METADATA_AGENT_MAX_ASSET_BYTES = int(
    os.getenv("DRAWING_METADATA_AGENT_MAX_ASSET_BYTES", str(512 * 1024 * 1024))
)
...
DRAWING_METADATA_DICTIONARY_SOURCE = os.getenv(
    "DRAWING_METADATA_DICTIONARY_SOURCE",
    "database",
).strip().lower()
